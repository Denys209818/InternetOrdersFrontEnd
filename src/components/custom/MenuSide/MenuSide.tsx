...
export type MenuSideType = {
    close: () => void;
};

export const MenuSide: React.FC<MenuSideType> = ({ close }) => {
            ...
            <nav>
                <ul className="list-none p-0">
                    <li className="block px-2 py-[18px]">
                        <Link to='/menu' onClick={close} className="block text-center font-lato text-asideMenu">Меню</Link>
                    </li>

                    <li className="block px-2 py-[18px]">
                        <Link to='/' onClick={close} className="block text-center font-lato text-asideMenu">Кошик</Link>
                    </li>
                </ul>
            </nav>
