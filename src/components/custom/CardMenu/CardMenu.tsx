...
export const CardMenu:React.FC<CardMenuType> = ({ title, type, tabletHuge = false }) => {
    const img = {
        shawarma: {
    ...
    return (
        <div className={`
            ...
            <div className={'flex items-center py-4 pl-2 gap-x-3 border-t-2 border-black ' + img[type].color}>
